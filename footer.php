...
<footer>
	<?php if ($this->options->useLinks == "able") { ?>
    <div class="link">
        <p>友情链接</p>
        <?php Links_Plugin::output('<span><a href="{url}" target="_blank">{name}</a></span>') ?>
        <hr>
    </div>
	<?php } ?>
    <span>&copy; <?php echo date('Y');$this->options->title(); ?> - <a
            href="<?php $this->options->feedUrl();?>"><?php Typecho_Widget::widget('Widget_Stat')->to($stat); ?><?php $stat->publishedPostsNum() ?>
            Posts crafted</a></span><span> ♥ <a href="https://blog.shuiba.co/bitcron-theme-hello">Hello</a> & <a
            href="https://github.com/PCDotFan/Aragaki">Aragaki</a> By <a
            href="https://www.xde.io/typecho/fantasy.html">Xingr</a></span>
